 ...
 * <p>
 * The {@code pageRange} and the page {@code body} are required inputs and are passed directly to the
 * {@code uploadPagesWithResponse} method, not through this options bag. This keeps the payload type correct at compile
